...
<<<<<<< Updated upstream
Dans notre exposé, nous nous interessons plus particulièrement aux inégalités qui existent entre les hommes et les femmmes, dans le domaine de l'IT. 
Ici, nous verrons s'il existe des inégalités au niveau : du nombre de postes pourvus, du salaires et de la position au sein de l'entreprise.
=======
Dans notre exposé, nous nous interessons plus particuilièrement aux ingéalités qui existent entre les hommes et les femmmes, dans ce domaine de l'IT. Nous nous intéressons plus particuilièrement à trois inégalités : nombre de postes pourvus, salaire et grade professionnel au sein de l'entreprise.
>>>>>>> Stashed changes

Source : Viktor Shcherban and Ksenia Legostay
...
carte = ggplot() + 
  ...
  theme(
    plot.title = element_text(color = "black", size = 12, hjust=0,face="bold"))
carte
```
...
```{r, echo = FALSE, eval = TRUE,  message = FALSE, warning=FALSE, fig.width= 12, fig.height = 8}
...
Grades professionnels selon l'âge
======================================================================
...
ggplot(data = dta_graph3,aes(x = list_age, 
                                       y = prop, 
                                       color = Genre,
                                       group=Genre)) +
  geom_line(linewidth=1.4) +
  labs(title = "Evolution du grade professionnel selon l'âge\npour les hommes et les femmes") +
